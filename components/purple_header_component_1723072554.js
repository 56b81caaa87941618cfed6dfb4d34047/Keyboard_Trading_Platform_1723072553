...
Vue.component("purple_header_component_1723072554", {
    template: `
    <header class="w-full z-30" id="header-section-container">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 bg-purple-900 bg-opacity-80 backdrop-blur-md">
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <nav id="desktop-navigation" class="hidden md:flex md:grow">
                    ...
                    <ul id="desktop-menu-links" class="flex grow justify-center flex-wrap items-center">
                        ...
                        <li><a id="Marketplace-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-white hover:text-purple-300" href="Marketplace.html">Marketplace</a></li>
                        <li><a id="Sell-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-white hover:text-purple-300" href="Sell.html">Sell</a></li>
                        <li><a id="Community-link" class="font-medium text-sm mx-4 lg:mx-5 transition duration-150 ease-in-out text-white hover:text-purple-300" href="Community.html">Community</a></li>
                ...
                <div id="mobile-menu" class="md:hidden flex items-center ml-4" x-data="{ expanded: false }">
                    ...
                    <nav id="mobile-nav" class="absolute top-full z-20 left-0 w-full px-4 sm:px-6 overflow-hidden transition-all duration-300 ease-in-out" x-ref="mobileNav" :style="expanded ? 'max-height: ' + $refs.mobileNav.scrollHeight + 'px; opacity: 1' : 'max-height: 0; opacity: .8'" @click.outside="expanded = false" @keydown.escape.window="expanded = false" x-cloak>
                        <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5 bg-purple-800">
                            <li><a id="mobile-Home-link" class="flex font-medium text-sm py-1.5 text-white hover:text-purple-300" href="Home.html">Home</a></li>
                            <li><a id="mobile-Marketplace-link" class="flex font-medium text-sm py-1.5 text-white hover:text-purple-300" href="Marketplace.html">Marketplace</a></li>
                            <li><a id="mobile-Sell-link" class="flex font-medium text-sm py-1.5 text-white hover:text-purple-300" href="Sell.html">Sell</a></li>
                            <li><a id="mobile-Community-link" class="flex font-medium text-sm py-1.5 text-white hover:text-purple-300" href="Community.html">Community</a></li>
        ...
        data() {
            return {
                expanded: false, 
                tab: null,
                textStylePrimary: 'text-green-400',
                hoverTextStylePrimary: 'hover:text-yellow-300',
                signUpButtonText: "text-green-400",
                signUpButtonHover: "hover:text-yellow-300",
                signUpButtonGradient: "[background:linear-gradient(theme(colors.gray.800),_theme(colors.gray.900))_padding-box,_conic-gradient(theme(colors.green.400),_theme(colors.blue.500)_25%,_theme(colors.blue.500)_75%,_theme(colors.green.400)_100%)_border-box]",
